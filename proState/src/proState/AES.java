...
public class AES {
	...
	private static final String SALT = "ssshhhhhhhhhh!!!!";
	...
	public static String encrypt(String strToEncrypt){
		try{
			...
			System.out.println("Errors while encrypting: " + e.toString());
		}
		return null;
	}
	...
	public static String decrypt(String strToDecrypt){
		try{
			...
			System.out.println("Errors while decrypting: " + e.toString());
		}
		return null;
	}
	...
	public static void main(String[] args) {
		...
		String originalString = "OmkarIngawale";
