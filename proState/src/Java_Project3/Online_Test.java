...
public class Online_Test extends JFrame implements ActionListener{
	...
	// Create Constructor => JFrame with radioButton and JButton 
	...
	// Handle all actions based on events
...
//			count = count + 1;
	...
	void set(){
		...
		if(current == 2){
			...
			radioButton[3].setText("Non of the Above");
		}
		if(current == 3){
		...
		if(current == 5){
			...
			radioButton[2].setText("Files.readFiles()");
	...
	public static void main(String[] args) {
		...
		new Online_Test("The Online Test App");
